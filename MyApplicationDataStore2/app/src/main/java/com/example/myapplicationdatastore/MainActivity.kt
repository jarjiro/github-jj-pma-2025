...
import com.example.myapplicationdatastore.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            repo.darkModeFlow.collectLatest { value ->
                ...
                // Reakce na dark mode pro preview
        ...
        lifecycleScope.launch {
            repo.usernameFlow.collectLatest { value ->
                ...
                // Reakce na username pro preview
        ...
        lifecycleScope.launch {
            repo.fontSizeFlow.collectLatest { value ->
                ...
                // Reakce na font size pro preview
